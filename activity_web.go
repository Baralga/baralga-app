...
func (a *app) HandleTrackingPage() http.HandlerFunc {
...
func TrackingPage(pageContext *pageContext, formModel activityTrackFormModel, filter *ActivityFilter, activitiesPage *ActivitiesPaged, projectsOfActivities []*Project, projects *ProjectsPaged) g.Node {
	return Page(
		"Track Activities",
