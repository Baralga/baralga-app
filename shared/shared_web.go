...
func Page(title, currentPath string, body []g.Node) g.Node {
	return HTML5Page(c.HTML5Props{
		...
		Head: []g.Node{
			...
			Script(
				Src("/assets/bootstrap-5.3.0-alpha3/bootstrap.bundle.min.js"),
				g.Attr("crossorigin", "anonymous"),
				g.Attr("integrity", "sha384-ENjdO4Dr2bkBIFxQpeoTz1HIcje39Wm4jDKdf19U8gI4ddQ3GYNS7NTKfAdVQSZe"),
				g.Attr("defer", "defer"),
			),
			Script(
				Src("/assets/htmx-1.9.2/htmx.min.js"),
				g.Attr("crossorigin", "anonymous"),
				g.Attr("defer", "defer"),
			),
		},
